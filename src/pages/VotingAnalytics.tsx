  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <Card className="mb-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0 shadow-lg">
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                <CardTitle className="text-2xl text-gray-900 dark:text-white mb-2 flex items-center gap-2">
                  <TrendingUp className="h-6 w-6" />
                  {election.title} - Analytics
                </CardTitle>
                <p className="text-gray-600 dark:text-gray-400">Real-time voting analytics and blockchain transparency</p>
              </div>
              <Badge className="bg-blue-100 text-blue-800 border-blue-200 font-medium animate-pulse">● Live</Badge>
            </div>
          </CardHeader>
          <CardContent>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-700/50">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-blue-700 dark:text-blue-300">{election.totalVotes.toLocaleString()}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 border-green-200 dark:border-green-700/50">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-green-700 dark:text-green-300">{participationRate.toFixed(1)}%</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-700/50">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-lg font-bold text-purple-700 dark:text-purple-300">{voteData[0].name}</p>
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 border-amber-200 dark:border-amber-700/50">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-amber-700 dark:text-amber-300">{election.totalVotes}</p>
              </div>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="space-y-4">
                {demographicData.map((item, index) => (
                  <div key={index} className="flex items-center justify-between">
                    <span className="text-sm text-gray-600 dark:text-gray-400">{item.demographic}</span>
        ...
        <Card className="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border-0 shadow-lg">
          <CardHeader>
