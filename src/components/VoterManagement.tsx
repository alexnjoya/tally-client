      ...
      <Card className="bg-white dark:bg-gray-800">
                ...
                <div className="space-y-4 py-4">
                  <div>
                    ...
                    <Input 
                      ...
                      className="border-blue-200 focus:border-blue-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                    />
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex">
                        <Input 
                          ...
                          className="border-blue-200 focus:border-blue-400 rounded-r-none bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                        />
                        <Button 
                          type="button"
                          variant="outline"
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">No voters added yet</p>
            <p className="text-sm text-gray-500 dark:text-gray-400">Add voters individually or import from a file</p>
          </div>
